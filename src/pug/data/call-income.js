;(() => {
  const data = [
    { interval: '8:00-8:30', count: [120, 130, 130] },
    { interval: '8:30-9:00', count: [95, 110, 118] },
    { interval: '9:00-9:30', count: [120, 120, 120] },
  ...
  const type = [
    { label: 'Answered Calls', color: '#37CE7D' },
    { label: 'Hung Up', color: '#4AA3EF' },
    { label: 'Abandoned', color: '#FF3C5F' }
  ]
